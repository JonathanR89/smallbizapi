...
return [
    ...
    'monitorBackups' => [
        [
            ...
            'storageUsedMayNotBeHigherThanMegabytes' => 500,
        ],
    ...
    'notifications' => [
         ...
         */
        'events' => [
            'whenBackupWasSuccessful'     => ['mail'],
            'whenCleanupWasSuccessful'    => ['mail'],
            'whenHealthyBackupWasFound'   => ['mail'],
            'whenBackupHasFailed'         => ['mail', 'mail'],
            'whenCleanupHasFailed'        => ['mail', 'mail'],
            'whenUnhealthyBackupWasFound' => ['mail', 'mail'],
        ],
