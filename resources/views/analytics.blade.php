				...
				<div class="col-md-12">
					<div class="panel panel-default">
						...
						<div class="alert alert-info">
							...
							<div class="row">
								<div class="col-md-5">
									<strong>Most popular page</strong>
									<br> {{-- @foreach ($popularPages as $key => $popularPage) {{ $popularPage }}
									<br> @endforeach --}}
									<table>
										<thead>
											<tr>
							...
							<div class="row">
								{{--
								<div class="col-md-5"> --}}
									<strong> Most time spent</strong>
									<br> @foreach ($maxTime->take(5) as $key => $popularPage) {{ $popularPage->page_from }}
									<strong>{{ gmdate("H:i:s",$popularPage->time_spent) }}</strong>
									<br> @endforeach {{-- </div> --}}
							</div>
						...
						<div class="alert alert-info">
							...
							<h3>{{$package[0]->name}}
								<br> occurrences: {{ $package['occurrences'] }}</h3>
