  ...
  <body>
    ...
    <table style="margin-top:20px; width:600px; border-radius:4px;">
        <tr>
            ...
            <td style="padding-left:15px;border-bottom:thin solid #d6d6d6; border-top:solid thin #d6d6d6;"><?php echo htmlspecialchars($price, ENT_QUOTES, 'utf-8') ?></td>
        </tr>
        <tr>
            <th style="background-color:#CCC;">Industry</th>
            <td style="padding-left:15px;border-bottom:thin solid #d6d6d6;"><?php echo htmlspecialchars($industry, ENT_QUOTES, 'utf-8') ?></td>
        </tr>
        <tr>
            <th style="background-color:#CCC;">Additional comments / requirements</th>
            <td style="padding-left:15px;border-bottom:thin solid #d6d6d6;"><?php echo htmlspecialchars($comments, ENT_QUOTES, 'utf-8') ?></td>
        </tr>
         <tr>
    ...
    <table width="600px" style="margin-top:20px; border-radius:4px;">
        <tr>
